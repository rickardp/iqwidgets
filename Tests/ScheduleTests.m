...
- (void)testDateAssignment
{
    ...
    [cv setStartDate:D(@"2010-01-13 05:43") endDate:D(@"2010-01-15 05:43")];
...
- (void)testWeekAssignment
{
    ...
    [cv setWeekWithDate:D(@"2011-02-16 23:59") workdays:NO];
    ...
    [cv setWeekWithDate:D(@"2011-02-16 23:59") workdays:YES];
